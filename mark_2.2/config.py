...
# 0.96 inch OLED Display (SSD1306) settings
OLED_CONFIG = {
    'enabled': True,              # Enable OLED display
    'i2c_port': 1,                # I2C port (usually 1 on Raspberry Pi)
    'i2c_address': 0x3C,          # I2C address (0x3C for most SSD1306 displays)
    'width': 128,                 # Display width in pixels
    'height': 64,                 # Display height in pixels
    'rotation': 180,              # Rotation angle (0, 90, 180, 270) - 180 for 360° rotated
    'k1_pin': 18,                 # GPIO pin for K1 button (Mode Switch)
    'k2_pin': 23,                 # GPIO pin for K2 button (Speed Switch)
    'k3_pin': 24,                 # GPIO pin for K3 button (Additional function)
}
...
# Bluetooth audio input settings
AUDIO_CONFIG = {
    'enabled': True,              # Enable Bluetooth audio input
    'sample_rate': 16000,         # Audio sample rate (Hz)
    'chunk_size': 1024,           # Audio chunk size
    'channels': 1,                # Number of audio channels (mono)
    'format': 16,                 # Audio bit depth
...
# Voice command recognition settings
VOICE_CONFIG = {
    'enabled': True,              # Enable voice commands
    'wake_words': [               # Wake words to activate assistant
        'hey assistant',
        'wake up',
        'assistant',
        'hello assistant'
    ],
    'commands': {                 # Voice commands mapping
        'chat mode': 'chat_mode',
    ...
    'listen_timeout': 1,          # Listen timeout in seconds
