    ...
    def _initialize_models(self):
        ...
        try:
            ...
            if self.oled_display:
                self.oled_display.show_status("Loading", "YOLOv8 Model...")
            ...
            if self.oled_display:
                self.oled_display.show_status("Error", "Model init failed")
            raise
...
Scene description:"""
    ...
    def analyze_scene(self):
        ...
        try:
            ...
            # Speak summary if voice manager available
            if self.voice_manager:
                self.voice_manager.speak(summary, blocking=False)
    ...
    def cleanup(self):
        """Clean up object mode resources."""
        try:
            if self.camera_manager:
                self.camera_manager.cleanup()
        except Exception as e:
            print(f"Error cleaning up object mode: {e}")
